define("./workbox-f7715658.js", ["exports"], function (t) {
  ...
  class L {
    ...
    async cachePut(t, e) {
      ...
      const l = await self.caches.open(h);
      const f = this.hasCallback("cacheDidUpdate");
      const w = f ? await async function (t, e, s, n) {
        const i = m(e.url, s);
      ...
      for (const t of this.iterateCallbacks("cacheDidUpdate"))
        await t({ cacheName: h, oldResponse: w, newResponse: a.clone(), request: r, event: this.event });
      return !0;
    }
    ...
    async getCacheKey(t, e) {
      if (!this.u[e]) {
        ...
        for (const t of this.iterateCallbacks("cacheKeyWillBeUsed"))
          s = U(await t({ mode: e, request: s, event: this.event, params: this.params }));
        this.u[e] = s;
      }
      return this.u[e];
    }
  ...
  class E extends i {
    constructor(t, e) {
      super(({ request: s }) => {
        ...
        for (const t of function* (t, { ignoreURLParametersMatching: e = [/^utm_/, /^fbclid$/], directoryIndex: s = "index.html", cleanURLs: n = !0, urlManipulation: i } = {}) {
...
//# sourceMappingURL=workbox-f7715658.js.map
